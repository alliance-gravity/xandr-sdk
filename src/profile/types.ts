...
interface Targeting {
  ...
  engagement_rate_targets?: {
    engagement_rate_type: '1: video_completion' | '2: view' | '3: view_over_total' | 
    '4: predicted_iab_video_view_rate' | '5: predicted_iab_video_view_rate_over_total' | 
    '6: predicted_100pv50pd_video_view_rate' | '7: predicted_100pv50pd_video_view_rate_over_total' | 
    '8: predicted_100pv1s_display_view_rate' | '9: predicted_100pv1s_display_view_rate_over_total' ;
