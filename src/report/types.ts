...
type ReportInterval = 'current_hour' | 'last_hour' | 'today' | 'yesterday' | 'last_48_hours' | 'last_2_days' |
  'last_7_days' | 'last_14_days' | 'month_to_yesterday' | 'month_to_date' | 'quarter_to_date' | 'last_month' |
  'lifetime' | '30_days';
